...
VALUES
       ...
       ('Lawyer','New', 'Provide guidance and advice on complex regulatory, compliance, and operational issues in the healthcare setting. Subject matters may include, but are not limited to pharmacy, the 340B Program, provider-based regulations, transactional work, healthcare venue options (free-standing ED’s, micro hospitals, ASC’s, etc.), provider enrollment, reimbursement, licensure, Medicare Conditions of Participation requirements, payor contracting, healthcare operations, fraud and abuse, contract review and negotiations, hospital/physician integration strategies, etc.'),
